...
import { Mail, ArrowLeft, ArrowRight, KeyRound, AlertCircle, ShieldCheck, Clock, Sparkles } from 'lucide-react';
import api from '../services/api';
import { useToast } from '../components/Toast';
import LoadingSpinner from '../components/LoadingSpinner';

export const ForgotPassword = ({ setActivePage, onEmailSubmitted, initialEmail = '' }) => {
